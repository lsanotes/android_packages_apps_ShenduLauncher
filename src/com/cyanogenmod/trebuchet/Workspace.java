...
public class Workspace extends PagedView
    ...
    private int[] mLastTargetCell = {-1,-1};
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        mFolderStyle = PreferencesProvider.Interface.Homescreen.getScreenFolderStyle(context, 
        		        		res.getString(R.string.config_folder_style_default));
    ...
    public boolean onTouch(View v, MotionEvent event) {
      ...
      //  return (isSmall() || mIsSwitchingState);
    	...
    	Log.i(Launcher.TAG, TAG+"onTouch...............return:."+ mIsSwitchingState);
...
//               }else{
//            
//            	   cellLayout.setBackgroundDrawable(cellLayout.mNormalBackground);
//               }
//       
...
//    }
    ...
    public boolean acceptDrop(DragObject d) {
        ...
        if (d.dragSource != this) {
            ...
            Log.i(Launcher.TAG,TAG+ "..acceptDrop.........getDragViewVisualCenter...............!!!!!   ");
            ...
            Log.i(Launcher.TAG,TAG+ "..acceptDrop.........findNearestArea(...............  ");
...
//                }
    ...
    boolean createUserFolderIfNecessary(View newView, long container, CellLayout target,
        ...
        if (aboveShortcut && willBecomeShortcut) {
         ...
         //   if (animate)
            if (animate && (mFolderStyle == FolderStyle.Ring)){
        ...
        if (d.dragSource != this) {
            ...
            if (dropTargetLayout != null) {
                ...
                mTargetCell = findNearestVacantArea((int) mDragViewVisualCenter[0],
                        (int) mDragViewVisualCenter[1], mDragInfo.spanX, mDragInfo.spanY, null,
                ...
                if (mTargetCell[0] >= 0 && mTargetCell[1] >= 0) {
                    ...
                    Log.i(Launcher.TAG, TAG+"..ondrops....moveItemInDatabase..........."+info.toString()+"    coor:"+ lp.cellX+lp.cellY);
                    LauncherModel.moveItemInDatabase(mLauncher, info, container, screen, lp.cellX,
                            lp.cellY);
                }
            }
            if(dropTargetLayout==mHotseat.getLayout()){
                mLauncher.getHotseat().viewMatchingCellInfo();	
            }
     
            Log.i(Launcher.TAG, TAG+"..ondrops....getParent()........cell.."+cell);
    ...
    for(int i = 0 ; i < count ; i++){
        ...
        cellLayoutChildren =mLauncher.getHotseat().getLayout().getChildrenLayout();
    ...
    //	Log.i(Launcher.TAG,TAG+ "..onDragEnter.........................empty:	"+mDragTargetLayout.toString());
//        if (mDragTargetLayout != null) {
...
//        mDragTargetLayout.onDragEnter();
   //    	Log.i(Launcher.TAG,TAG+ "..onDragEnter.........................empty22:	"+mDragTargetLayout.toString());
    ...
    public void onDragExit(DragObject d) {
    	Log.i(Launcher.TAG,TAG+ "..onDragExit.........................empty:	");
        doDragExit(d);
    }
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    private int[] mLastEmptyCell = new int[2];
    ...
    private void realTimeReorder(int[] empty, int[] target) {
      ...
      //  float delayAmount = 100;
        if(isInHotseat){
        	...
        	currentLayout  =  ((CellLayout) getChildAt(mCurrentPage));	
        }
        ItemInfo info =null;
        if (readingOrderGreaterThan(target, empty)) {
            ...
            for (int y = startY; y <= target[1]; y++) {  // Y from Target  to empty  
             ...
             Log.i(Launcher.TAG,TAG+ "..realTimeReorder...00...............info.itemType:."+info.itemType);
    ...
    public void onDragOver(DragObject d) {
     ...
     //
            ...
            if (layout != mDragTargetLayout) {
                if (mDragTargetLayout != null) {
                  ...
                  if(mDragTargetLayout == mHotseat.getLayout()){
                	...
                	//  getParentCellLayoutForView(d.dragView).removeView(d.dragView);
                      ...
                      mHotseat.setGridSize(mHotseat.mCellCountX-1,false);
                      
                      
                      int numbers = mDragTargetLayout.getChildrenLayout().getChildCount();
                      
                      
                	  for(int i = 0 ; i <numbers; i++){
                		  
                      	View view =mDragTargetLayout.getChildrenLayout().getChildAt(i);
                      		  
                          Log.i(Launcher.TAG,TAG+ ".onDragOver....for().....................:"+view.getTag());  
              ...
              Log.i(Launcher.TAG,TAG+ ".onDragOver..........setGridSize(1).............:"
              +(mDragTargetLayout == mLauncher.getHotseat().getLayout())
              +!(mDragTargetLayout.getChildrenLayout().getChildCount()>=5)+mHotseat);
              
              
              if(mDragTargetLayout == mHotseat.getLayout() &&(mHotseat.mCellCountX<5)){
            	 // mLauncher.getHotseat().viewMatchingCellInfo();
            	  mHotseat.setGridSize(mHotseat.mCellCountX+1,true);  		
             	}
          ...
          //  Log.i(Launcher.TAG,TAG+ "..onDragOver.........findNearestArea...............!!!!!   ");
            
            mTargetCell = findNearestArea((int) mDragViewVisualCenter[0],
                    (int) mDragViewVisualCenter[1], 1, 1, mDragTargetLayout, mTargetCell);
 
          //  Log.i(Launcher.TAG, TAG+"onDragOver............  mTargetCell :   "+mTargetCell[0]+mTargetCell[1]);
     ...
     //   Log.i(Launcher.TAG, TAG+"onDragOver............  distance :"+distance + " X:"+Math.abs(cellXY[0] - mDragViewVisualCenter[0])+" Y:"+Math.abs(cellXY[1] - mDragViewVisualCenter[1]));
       ...
       //    Log.i(TAG, TAG+"       willCreateUserFolder22  "  +(dragOverView != mLastDragOverView)+"   "+userFolderPending);
            ...
            if (!mCreateUserFolderOnDrop && !isOverFolder) {
            	...
            	//  Log.i(Launcher.TAG,TAG+ "..onDragOver.........visualizeDropLocation...............!!!!!   ");
...
//                realTimeReorder(empty, target);
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        Log.i(Launcher.TAG,TAG+ "..onDropExternal......................!!!!! info.itemType:  "+info.itemType);
        ...
        if (info instanceof PendingAddItemInfo) {
           ...
           // 	pendingInfo.itemType = LauncherSettings.Favorites.ITEM_TYPE_DELETESHOETCUT;
    ...
    void removeItems(final ArrayList<ShortcutInfo> apps) {
        ...
        for (ShortcutInfo app : apps) {
            ...
            ContentResolver forIdCR = mLauncher.getContentResolver();
        	Cursor forIdCursor = forIdCR.query(LauncherSettings.Favorites.CONTENT_URI,null,"intent = "
        			+"\'"+app.intent.toURI()+"\'",null, null);
        	if(forIdCursor.moveToFirst()){
        		int appId = forIdCursor.getInt(forIdCursor.getColumnIndex(LauncherSettings.Favorites._ID));
            	app.id = appId;
        	}
        	forIdCursor.close();
        	forIdCR = null;
...
//    void updataDBWhenRemoveScreen(int pageCount,int addOrRemove){
//    	
...
//
// 	     
// 		 db.execSQL("UPDATE "+LauncherProvider.TABLE_FAVORITES+" SET screen = screen +" +addOrRemove+ " WHERE screen>="+pageCount +" and container ="+LauncherSettings.Favorites.CONTAINER_DESKTOP+";"); 
